...
- **Local changes:** `deployment.toml` reflects our testnet deployment config; `contracts/groth16-verifier/src/test.rs`
  has a minor local edit from the de-risk phase. Build artifacts (`target/`) and the upstream `.git`
